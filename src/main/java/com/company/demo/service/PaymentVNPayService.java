...
import com.company.demo.repository.TransactionRepository;
import com.company.demo.util.vnpay.VnpayConfig;
...
public class PaymentVNPayService {
    ...
    public Order updateOrderPaymentStatus(Long orderId){
